...
void get_data(int i){       //Function for receiving data from user and populatiing the variables with values.
    ...
    //     cout << "Enter marks for Bangla: ";
    //     int mrks;
    //     cin >> rec[i].marks[2];
    // }
    // cout << "Enter total days taught for each subject: \n";
    // cout << "Average marks for each subject: \n";
    // if(rec[i].subject[0] == 1){
    //     cout << "Enter total days for Math: ";
    //     int mrks;
    //     cin >> rec[i].taught[0];
    // }
    // if(rec[i].subject[1] == 1){
    //     cout << "Enter total days for English: ";
    //     int mrks;
    //     cin >> rec[i].taught[1];
    // }
    // if(rec[i].subject[2] == 1){
    //     cout << "Enter total days for Bangla: ";
    //     int mrks;
    //     cin >> rec[i].taught[2];
    // }
    // cout << "Enter total earnings: ";
    // cin >> rec[i].earn;
...
void show_overall_info(){
    ...
    cout << "Individual days taught in each class:  " << class_overall[0] << "  " << class_overall[1] << "  " << class_overall[2] << "\n";

    cout << "Total earnings:  " << class_overall[0] + class_overall[1] + class_overall[2] << "\n";
    cout << "Individual earnings of each class:  " << class_overall[0] << "  " << class_overall[1] << "  " << class_overall[2] << "\n";


    cout << "Individual earnings of each subject:  " << earning_sub_overall[0] << "  " << earning_sub_overall[1] << "  " << earning_sub_overall[2] << "\n";
